...
- Full verification: 18 test files / 286 tests passed; lint and TypeScript exited 0; the production build succeeded after rerunning outside the sandbox because Turbopack's CSS worker needs to bind an internal port.
